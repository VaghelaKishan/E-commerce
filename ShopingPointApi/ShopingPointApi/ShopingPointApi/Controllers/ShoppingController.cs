...
using ShopingPointApi.DataAccess;
using ShopingPointApi.Models;

namespace ShopingPointApi.Controllers
{
    ...
    public class ShoppingController : ControllerBase
    {
        ...
        public ShoppingController(IDataAccess dataAccess, IConfiguration configuration)
        {
            ...
            DataFormat = configuration["Constants:DataFormat"];
        }
        ...
        {
            user.CreatedAt = DateTime.Now.ToString(DataFormat);
            user.ModifiedAt = DateTime.Now.ToString(DataFormat);
        ...
        {
            review.CreatedAt = DateTime.Now.ToString(DataFormat);
